...
<template>
  <div>
    ...
    <q-form @submit="onSubmit">
      <q-card v-show="config.rootFolders.length" class="q-ma-md">
        <q-toolbar>
          <q-toolbar-title>文件夹列表</q-toolbar-title>
        </q-toolbar>

        <q-list>
          <q-item v-for="rf in config.rootFolders" :key="rf.name">
      ...
      <q-card class="q-ma-md">
        ...
        <q-input v-else v-model="config.coverFolderDir" outlined dense required class="q-pa-sm" />
      </q-card>
